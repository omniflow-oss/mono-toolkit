...
import { listScopesCommand, listPortsCommand, listChangedCommand } from "../src/cli/commands/list";
...
const scopes: ScopeRecord[] = [
  { id: "back:service:alpha", type: "service", path: "back/services/alpha", profile: "default", tags: [], port: 8080 },
  { id: "back:service:beta", type: "service", path: "back/services/beta", profile: "default", tags: [] }
];
